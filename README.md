...
2) Краткий разведочный анализ данных. С помощью инструментов statsmodels изучены наши данные, чтобы строить гипотезы, какие модели стоит тренировать. Основные пункты сохранены в analyze.py
...
### Вариант 2. 
Позволяем Docker'у установить библиотеки.
...
Параметры опять же подбирал кроссвалидацией через сдвиг. Фичи (лаги и скользящие средние) добавлялись по-одному, хорошо тренировали модель равноудаленные лаги (1-6-12), (2-7-12).
